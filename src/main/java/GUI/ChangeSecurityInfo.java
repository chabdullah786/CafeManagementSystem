 ...
 * @author chabd
 */
public class ChangeSecurityInfo extends javax.swing.JFrame {

    public String userEmail;

    /**
     * Creates new form ChangeSecurityInfo
     */
    public ChangeSecurityInfo() {
        initComponents();
    }

    public ChangeSecurityInfo(String email) {
        initComponents();
        userEmail = email;
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon("C:\\Users\\chabd\\OneDrive\\Documents\\NetBeansProjects\\CMSystem\\src\\main\\java\\images\\small-page-background.png")); // NOI18N

        jLabel7.setIcon(new javax.swing.ImageIcon("C:\\Users\\chabd\\OneDrive\\Documents\\NetBeansProjects\\CMSystem\\src\\main\\java\\images\\small-page-background.png")); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\chabd\\OneDrive\\Documents\\NetBeansProjects\\CMSystem\\src\\main\\java\\images\\change Security Question.png")); // NOI18N
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 10, 34, -1));
        ...
        getContentPane().add(txtOldSQ, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 120, 310, -1));
        ...
        getContentPane().add(txtNewSQ, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 180, 309, -1));

        txtNewAns.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        txtNewAns.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtNewAnsKeyReleased(evt);
            }
        });
        getContentPane().add(txtNewAns, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 230, 309, -1));

        jPasswordField.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        jPasswordField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jPasswordFieldKeyReleased(evt);
            }
        });
        getContentPane().add(jPasswordField, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 280, 309, -1));
        ...
        getContentPane().add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 334, -1, 39));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(486, 334, -1, 39));

        jLabel8.setIcon(new javax.swing.ImageIcon("C:\\Users\\chabd\\OneDrive\\Documents\\NetBeansProjects\\CMSystem\\src\\main\\java\\images\\small-page-background.png")); // NOI18N
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        setVisible(false);
        new ChangeSecurityInfo(userEmail).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangeSecurityInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangeSecurityInfo().setVisible(true);
            }
        });
    }
